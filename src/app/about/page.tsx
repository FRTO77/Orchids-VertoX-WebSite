        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
            ...
            <motion.div
              ...
              className="glass p-8 md:p-12 rounded-[40px] border-border/50 text-center"
            >
              <h2 className="text-3xl font-bold mb-6 italic text-white">"Language is the road map of a culture. It tells you where its people come from and where they are going."</h2>
              <div className="flex items-center justify-center gap-3">
                <div className="w-12 h-12 rounded-full bg-muted border border-border" />
                <div className="text-left">
                  <div className="font-bold text-white">Alex Rivera</div>
                  <div className="text-sm text-zinc-400">CEO & Founder, VertoX</div>
                </div>
              </div>
            </motion.div>
        </div>
      ...
      <main className="flex-grow pt-32 pb-24 px-4">
        <div className="container mx-auto max-w-5xl">
            <motion.div
              ...
              className="text-center mb-16"
            >
              <h1 className="text-5xl md:text-7xl font-heading font-black mb-6 text-white">Our <span className="text-primary">Mission.</span></h1>
