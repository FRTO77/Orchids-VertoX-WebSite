    ...
    <div className="min-h-screen flex bg-white dark:bg-black">
        ...
        <div className="relative z-10 flex flex-col justify-between p-16 text-white dark:text-black">
          ...
          <div>
            ...
            <p className="text-white/60 dark:text-black/60 font-light leading-relaxed max-w-md">
              Sign in to access your account and continue breaking language barriers.
            </p>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <div className="mb-10">
            <h2 className="text-4xl font-serif font-light mb-2">Sign in</h2>
          ...
          <form onSubmit={handleAuth} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <Link href="#" className="text-xs text-black/40 dark:text-white/40 hover:text-black dark:hover:text-white transition-colors">
                  Forgot password?
                </Link>
              </div>
              <Input 
