      ...
      <main className="flex-grow pt-32 pb-24 px-4 text-center">
        <div className="container mx-auto max-w-5xl">
          <motion.div
            ...
            className="mb-16"
          >
            <h1 className="text-5xl md:text-7xl font-heading font-black mb-6">Join the <span className="text-primary">VertoX</span> Community.</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {social.map((s, i) => (
              <motion.div
                ...
                className="glass p-8 rounded-[40px] border-border/50 hover:border-primary/50 transition-all group"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 text-left">
            ...
            >
              ...
              <h2 className="text-3xl font-bold mb-4">VertoX Champions</h2>
              ...
              <Button variant="outline" className="rounded-xl border-primary/30 text-primary">Learn More</Button>
            </motion.div>
            ...
            >
              ...
              <Button variant="outline" className="rounded-xl border-purple-500/30 text-purple-500">Explore Gallery</Button>
            </motion.div>
          </div>
        </div>
      </main>
