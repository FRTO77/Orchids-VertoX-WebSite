      ...
      <main className="flex-grow pt-32 pb-24 px-4">
        <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-16">
              <h1 className="text-5xl md:text-7xl font-heading font-black mb-6 text-white">Get in <span className="text-primary">Touch.</span></h1>
              ...
              {[
                ...
                >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="text-sm font-bold text-zinc-400 uppercase tracking-widest">{item.label}</div>
